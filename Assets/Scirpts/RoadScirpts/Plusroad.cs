...
public class Plusroad : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        CreateRoadPart("Pavement", new Vector3(10, 1, 2.5f), new Vector3(20, 0, -12));

        CreateRoadPart("Pavement", new Vector3(10, 1, 2.5f), new Vector3(20, 0, 10));
        ...
        CreateRoadPart("Pavement 2", new Vector3(2.5f, 1, 11f), new Vector3(-12, 0, 19));

        CreateRoadPart("Pavement 2", new Vector3(2.5f, 1, 10f), new Vector3(-12, 0, -20));
